...
function _default(job) {
  var frequency = job.frequency,
      limit = job.limit;

  var isNumber = function isNumber(frequency) {
    return typeof frequency === 'number';
  };

  var frequencyType;
  if (!frequency) return; // When frequency is not a number simple bull asume it's a cron
